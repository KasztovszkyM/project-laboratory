  ...
  void Start()
    ...
    void Update(){
        ...
        if (Input.GetMouseButton(0)) 
        {
            ...
            Vector3 localPoint = new Vector3(worldPoint.x / (Renderer.displayWidth/2.0f), worldPoint.y / (Renderer.displayHeight/2.0f));//transform.InverseTransformPoint(worldPoint);
